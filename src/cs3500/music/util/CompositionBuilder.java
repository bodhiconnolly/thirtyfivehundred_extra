 ...
 * the name of the main type is for a cs3500.music.model, we parameterize this builder interface
 * by an unknown type.
 *
...
public interface CompositionBuilder<T> {
   ...
   * @param pitch The pitch (in the range [0, 127], where 60 represents, the middle-C on a piano).
